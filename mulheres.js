...
const router = express.Router() //aqui estou iniciando a primeira parte da rota, baixando a biblioteca express
const cors = require('cors') //trazendo o pacote cors, que permite consumir a api no front-end
const conectaBancoDeDados = require('./bancoDeDados'); //aqui estou ligando o banco de dados aquivo ./bancoDeDados
conectaBancoDeDados() //estou chamando a função que conecta o banco de dados


const Mulher = require('./mulherModel')
const app = express() //aqui estou inciando o app
